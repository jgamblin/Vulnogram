      ...
      for (const eq2mx of highestSeverityVectors[2][eq2]) {
        for (const eq3eq6mx of highestSeverityVectors[3][eq3][eq6]) {
          for (const eq4mx of highestSeverityVectors[4][eq4]) {
            ...
            const avsvdst = CVSS40.severityDistance(
              "AV",
              this.getReal("AV"),
              CVSS40.getValue(partial, "AV"),
            );
            const prsvdst = CVSS40.severityDistance(
              "PR",
              this.getReal("PR"),
              CVSS40.getValue(partial, "PR"),
            );
            const uisvdst = CVSS40.severityDistance(
              "UI",
              this.getReal("UI"),
              CVSS40.getValue(partial, "UI"),
            );
            const acsvdst = CVSS40.severityDistance(
              "AC",
              this.getReal("AC"),
              CVSS40.getValue(partial, "AC"),
            );
            const atsvdst = CVSS40.severityDistance(
              "AT",
              this.getReal("AT"),
              CVSS40.getValue(partial, "AT"),
            );
            const vcsvdst = CVSS40.severityDistance(
              "VC",
              this.getReal("VC"),
              CVSS40.getValue(partial, "VC"),
            );
            const visvdst = CVSS40.severityDistance(
              "VI",
              this.getReal("VI"),
              CVSS40.getValue(partial, "VI"),
            );
            const vasvdst = CVSS40.severityDistance(
              "VA",
              this.getReal("VA"),
              CVSS40.getValue(partial, "VA"),
            );
            const scsvdst = CVSS40.severityDistance(
              "SC",
              this.getReal("SC"),
              CVSS40.getValue(partial, "SC"),
            );
            const sisvdst = CVSS40.severityDistance(
              "SI",
              this.getReal("SI"),
              CVSS40.getValue(partial, "SI"),
            );
            const sasvdst = CVSS40.severityDistance(
              "SA",
              this.getReal("SA"),
              CVSS40.getValue(partial, "SA"),
            );
            const crsvdst = CVSS40.severityDistance(
              "CR",
              this.getReal("CR"),
              CVSS40.getValue(partial, "CR"),
            );
            const irsvdst = CVSS40.severityDistance(
              "IR",
              this.getReal("IR"),
              CVSS40.getValue(partial, "IR"),
            );
            const arsvdst = CVSS40.severityDistance(
              "AR",
              this.getReal("AR"),
              CVSS40.getValue(partial, "AR"),
            );
            if (
              [
                avsvdst,
            ...
            eq3eq6svdst =
              vcsvdst + visvdst + vasvdst + crsvdst + irsvdst + arsvdst;
